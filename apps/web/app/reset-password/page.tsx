    ...
    <Suspense
      fallback={
        <main className="auth-flow-page">
          <section className="public-form">Loading...</section>
        </main>
      }
    >
...
function ResetPasswordContent() {
  ...
  const copy =
    resetCopy[language as keyof typeof resetCopy] ??
    extraResetCopy[language] ??
    resetCopy.en;
  const [email, setEmail] = useState("");
  const [password, setPassword] = useState("");
  const [status, setStatus] = useState<string>(
    token ? copy.newPasswordHint : copy.emailHint,
  );
  ...
  return (
    <main className="auth-flow-page">
      <form className="public-form" onSubmit={submit}>
        ...
        <a className="auth-inline-link" href={`/?lang=${language}#login`}>
          {copy.back}
        </a>
      </form>
    </main>
  ...
  [
    [
      ...
      [
        ...
        "Saisissez un nouveau mot de passe d'au moins 8 caractères.",
        "Envoyer le lien",
    ...
    [
      ...
      [
        ...
        "Email",
        "Nueva contraseña",
        "Escribe tu email para recibir un enlace.",
        "Escribe una nueva contraseña de al menos 8 caracteres.",
        "Enviar enlace",
        "Actualizar contraseña",
        "Si este email existe, se envió un enlace.",
    ...
    [
      ...
      [
        ...
        "E-Mail",
        "Neues Passwort",
        "Geben Sie Ihre E-Mail ein, um einen Link zu erhalten.",
        "Geben Sie ein neues Passwort mit mindestens 8 Zeichen ein.",
        "Link senden",
        "Passwort aktualisieren",
        "Falls diese E-Mail existiert, wurde ein Link gesendet.",
    ...
    [
      ...
      [
        ...
        "Invia link",
        "Aggiorna password",
        "Se l'email esiste, il link e stato inviato.",
    ...
    [
      ...
      [
        ...
        "Enviar link",
        "Atualizar senha",
        "Se este email existir, o link foi enviado.",
    ...
    [
      ...
      [
        ...
        "メール",
        "新しいパスワード",
        "リセットリンクを受け取るメールを入力してください。",
        "8文字以上の新しいパスワードを入力してください。",
        "リンクを送信",
        "パスワード更新",
        "メールが存在する場合、リンクを送信しました。",
        "パスワードを更新しました。再ログインしてください。",
        "リセットに失敗しました。",
        "ログインへ戻る",
      ],
    ],
    [
      ...
      [
        ...
        "링크 보내기",
        "비밀번호 업데이트",
        "이 이메일이 있으면 링크가 전송되었습니다.",
        "비밀번호가 업데이트되었습니다. 다시 로그인하세요.",
        "비밀번호 재설정 실패.",
        "로그인으로 돌아가기",
      ],
    ],
    [
      ...
      [
        ...
        "ईमेल",
        "नया पासवर्ड",
        "रीसेट लिंक पाने के लिए ईमेल दर्ज करें।",
        "कम से कम 8 अक्षरों का नया पासवर्ड दर्ज करें।",
        "रीसेट लिंक भेजें",
        "पासवर्ड अपडेट करें",
        "यदि ईमेल मौजूद है, लिंक भेजा गया।",
        "पासवर्ड अपडेट हुआ। फिर साइन इन करें।",
        "पासवर्ड रीसेट विफल।",
        "लॉगिन पर वापस",
      ],
    ],
    [
      ...
      [
        ...
        "ای میل",
        "نیا پاس ورڈ",
        "ری سیٹ لنک کے لیے ای میل درج کریں۔",
        "کم از کم 8 حروف کا نیا پاس ورڈ درج کریں۔",
        "ری سیٹ لنک بھیجیں",
        "پاس ورڈ اپ ڈیٹ کریں",
        "اگر ای میل موجود ہے تو لنک بھیج دیا گیا۔",
        "پاس ورڈ اپ ڈیٹ ہو گیا۔ دوبارہ لاگ ان کریں۔",
    ...
    [
      ...
      [
        ...
        "ایمیل",
        "رمز جدید",
        "برای دریافت لینک بازنشانی ایمیل را وارد کنید.",
        "رمز جدید حداقل 8 کاراکتر وارد کنید.",
        "ارسال لینک",
        "به‌روزرسانی رمز",
        "اگر ایمیل وجود داشته باشد، لینک ارسال شد.",
        "رمز به‌روزرسانی شد. دوباره وارد شوید.",
    ...
    [
      ...
      [
        ...
        "אימייל",
        "סיסמה חדשה",
        "הזן אימייל לקבלת קישור איפוס.",
        "הזן סיסמה חדשה לפחות 8 תווים.",
        "שלח קישור",
        "עדכן סיסמה",
        "אם האימייל קיים, הקישור נשלח.",
        "הסיסמה עודכנה. התחבר שוב.",
        "איפוס הסיסמה נכשל.",
        "חזרה להתחברות",
      ],
    ],
    [
      ...
      [
        ...
        "Kirim tautan",
        "Perbarui kata sandi",
        "Jika email ada, tautan telah dikirim.",
        "Kata sandi diperbarui. Masuk lagi.",
        "Atur ulang gagal.",
        "Kembali masuk",
      ],
    ],
    [
      ...
      [
        ...
        "E-mel",
        "Kata laluan baharu",
        "Masukkan e-mel untuk menerima pautan.",
        "Masukkan kata laluan baharu sekurang-kurangnya 8 aksara.",
        "Hantar pautan",
        "Kemas kini kata laluan",
        "Jika e-mel wujud, pautan telah dihantar.",
        "Kata laluan dikemas kini. Log masuk semula.",
        "Tetapan semula gagal.",
    ...
    [
      ...
      [
        ...
        "Email",
        "Новий пароль",
        "Введіть email, щоб отримати посилання.",
        "Введіть новий пароль щонайменше 8 символів.",
        "Надіслати посилання",
        "Оновити пароль",
        "Якщо email існує, посилання надіслано.",
        "Пароль оновлено. Увійдіть знову.",
        "Скидання пароля не вдалося.",
        "Назад до входу",
      ],
    ],
    [
      ...
      [
        ...
        "Email",
        "Nowe hasło",
        "Wpisz email, aby otrzymać link.",
        "Wpisz nowe hasło min. 8 znaków.",
        "Wyślij link",
        "Aktualizuj hasło",
        "Jeśli email istnieje, link został wysłany.",
    ...
    [
      ...
      [
        ...
        "E-mail",
        "Nieuw wachtwoord",
        "Voer e-mail in voor resetlink.",
        "Voer nieuw wachtwoord in van minstens 8 tekens.",
        "Stuur link",
        "Wachtwoord bijwerken",
        "Als e-mail bestaat, is link verzonden.",
    ...
    [
      ...
      [
        ...
        "E-post",
        "Nytt lösenord",
        "Ange e-post för återställningslänk.",
        "Ange nytt lösenord med minst 8 tecken.",
        "Skicka länk",
        "Uppdatera lösenord",
        "Om e-post finns har länk skickats.",
        "Lösenord uppdaterat. Logga in igen.",
    ...
    [
      ...
      [
        ...
        "Email",
        "Νέος κωδικός",
        "Εισαγάγετε email για σύνδεσμο επαναφοράς.",
        "Εισαγάγετε νέο κωδικό τουλάχιστον 8 χαρακτήρων.",
        "Αποστολή συνδέσμου",
        "Ενημέρωση κωδικού",
        "Αν το email υπάρχει, στάλθηκε σύνδεσμος.",
        "Ο κωδικός ενημερώθηκε. Συνδεθείτε ξανά.",
        "Η επαναφορά απέτυχε.",
        "Πίσω στη σύνδεση",
      ],
    ],
    [
      ...
      [
        ...
        "Mật khẩu đã cập nhật. Đăng nhập lại.",
        "Đặt lại thất bại.",
        "Quay lại đăng nhập",
      ],
    ],
    [
      ...
      [
        ...
        "กรอกรหัสผ่านใหม่อย่างน้อย 8 ตัวอักษร",
        "ส่งลิงก์",
        "อัปเดตรหัสผ่าน",
        "หากมีอีเมลนี้ ระบบส่งลิงก์แล้ว",
        "อัปเดตรหัสผ่านแล้ว เข้าสู่ระบบอีกครั้ง",
...
function resetFromList(values: string[]): ResetCopy {
  return {
    forgotTitle: values[0] ?? "",
    resetTitle: values[1] ?? "",
    email: values[2] ?? "",
    newPassword: values[3] ?? "",
    emailHint: values[4] ?? "",
    newPasswordHint: values[5] ?? "",
    send: values[6] ?? "",
    update: values[7] ?? "",
    sent: values[8] ?? "",
    updated: values[9] ?? "",
